...
/**
 * DTO para criação de plano nutricional
 */
public class CreateNutritionPlanDTO {

    @NotNull(message = "A data do plano é obrigatória")
    @FutureOrPresent(message = "A data do plano deve ser hoje ou no futuro")
