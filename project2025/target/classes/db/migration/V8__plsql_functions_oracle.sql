...
-- =====================================
-- FUNCTION 1: Calcular Indicador de Saúde do Usuário
-- =====================================
-- Calcula um indicador de saúde baseado nos planos nutricionais
-- Retorna um score de 0 a 100 baseado em:
-- - Calorias consumidas vs recomendadas
-- - Equilíbrio de macronutrientes
-- - Hidratação adequada
-- - Consistência (planos completados)
-- =====================================

CREATE OR REPLACE FUNCTION calcular_indicador_saude_usuario(
...
-- =====================================
-- FUNCTION 2: Formatar Relatório de Nutrição
-- =====================================
-- Retorna um relatório formatado em texto com estatísticas
-- nutricionais de um usuário em um período específico
-- =====================================

CREATE OR REPLACE FUNCTION formatar_relatorio_nutricao(
    p_user_id IN VARCHAR2,
